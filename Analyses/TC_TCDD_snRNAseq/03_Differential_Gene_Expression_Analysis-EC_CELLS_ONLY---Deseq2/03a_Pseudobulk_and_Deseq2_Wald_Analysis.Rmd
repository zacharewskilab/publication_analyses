...
#Import Data
```{r}
adata <- ad$read_h5ad("/mnt/ufs18/home-183/cholicog/snRNAseq_Analysis/01_Libraries_Integration_and_Analysis---scVI/Adata_Objects/01e_AllGenes_Clustered_Endo.h5ad")
```
...
# Combine 'OrigIdent' and 'Cell_Subtype' columns into a new column
sce$OrigIdent_Cell_Subtype <- paste(sce$OrigIdent, sce$Cell_Subtype, sep="_")
sce$OrigIdent_Cell_Subtype <- gsub(" ", "_", sce$OrigIdent_Cell_Subtype)

#Export sample names
ids <- sce$OrigIdent_Cell_Subtype
...
```{r}
pseudobulk$Dose_Time <- paste(pseudobulk$Dose, pseudobulk$Time, sep="_")
...
metadata2 <- metadata[c('OrigIdent_Cell_Subtype', 'Dose', 'Time', 'Dose_Time','OrigIdent', 'Cell_Subtype')]


metadata5 <- metadata2

#Reindex Metadata adn reorder columns
row.names(metadata5) <- metadata5$OrigIdent_Cell_Subtype
metadata5 <- metadata5[order(metadata5$OrigIdent_Cell_Subtype),]
```
...
####################
```{r}
Celltype_Of_Interest = "Pericentral LSECs"
Celltype_Of_Interest.NoSpace <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
Celltype_Of_Interest <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
...
metadata5_subset <- metadata5[grepl(Celltype_Of_Interest, metadata5$OrigIdent_Cell_Subtype), ]
metadata5_subset
...
####################
```{r}
Celltype_Of_Interest = "Midzonal LSECs"
Celltype_Of_Interest.NoSpace <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
Celltype_Of_Interest <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
...
####################
```{r}
Celltype_Of_Interest = "Periportal LSECs"
Celltype_Of_Interest.NoSpace <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
Celltype_Of_Interest <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
...
####################
```{r}
Celltype_Of_Interest = "Periportal VECs"
Celltype_Of_Interest.NoSpace <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
Celltype_Of_Interest <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
...
####################
```{r}
Celltype_Of_Interest = "Pericentral VECs"
Celltype_Of_Interest.NoSpace <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
Celltype_Of_Interest <- gsub(" ", "_", Celltype_Of_Interest)  # Replace spaces with underscores
